      ...
      <section id="about" className="section">
        ...
        <div className="about-grid">
          <div className="about-prose reveal">
            <p>MBA in Finance &amp; Business Analytics from <strong>Sri Ramakrishna College of Arts and Science, Coimbatore</strong> (Autonomous; affiliated to Bharathiar University), graduating April 2026. Prior BBA from the same institution (2021–2024). Spent the past year building financial models independently — LBO, DCF, banking, M&amp;A buy-side and FP&amp;A — and developing ML analytics and automation skills alongside.</p>
